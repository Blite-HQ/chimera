...
6. Tabla de interacciones de tu sesión en docs/mvp/decisiones.md.
...
cambios de código de features (eso vive en el backlog G/P/C/V/O); el codename de
...
- [ ] Los 5 supersedes pendientes aplicados (#102, C-9, C-10, N12, M9).

...
- **La cola de trabajos no está cableada**: el contenedor `worker` está inerte, y los
  runs corren en el proceso de la API (bien para cargas locales, no para trabajos de
  horas).

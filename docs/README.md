...
| [`mejorado/`](mejorado/)         | VIGENTE — active phase | `00-playbook` · `01-criterio` (#101) · `02-cobertura` · `03-research` · `04-consolidacion` (THE backlog) · `05-plan-paralelo` · `06-saneamiento` (#107) · `07-censo-documental`                                                                                       |

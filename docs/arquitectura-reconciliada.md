...
> **[S3 2026-07-30]** El desempate de autoridad entre las tres arquitecturas (`arquitectura-python.md`, este doc y `arquitectura-arc42-adrs.md`) queda resuelto por el mapa sección→doc del índice (`docs/README.md`, decisión #108): este doc sigue valiendo solo por las secciones listadas arriba. El conflicto con `docs/archivo/planeado/02-cobertura-diseno.md:37` — que llamaba a este doc «la arquitectura VIGENTE» — muere con el archivo de ese doc.

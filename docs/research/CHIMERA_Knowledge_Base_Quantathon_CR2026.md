...
> `CHIMERA_Proyecto_Quantathon_CR2026` y `Blite_Engine_Arquitectura_POC`.
...
- Paper: *Migrating QAOA from Qiskit 1.x to 2.x: An experience report* — https://arxiv.org/abs/2512.08245
...
1. **REGRID-QAOA** (ver §1.2) — post-procesamiento y verificación clásica de salidas
   ...
   con otro nombre; úsalo como validación externa de la tesis del Blite Engine.

...
and will take appropriate, fair corrective action in response to any behavior deemed
...
maintainer listed in [`SECURITY.md`](SECURITY.md) (email, subject `[CONDUCT] — <summary>`).

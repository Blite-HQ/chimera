...
class StructuralPartitionVerifier:
    ...
    def verify_all(self, claim: Any, ctx: InvocationContext) -> tuple[Attestation, ...]:
        ...
        separado. Explícito porque satisface `Verifier` ESTRUCTURALMENTE — un
        Protocol `runtime_checkable` exige el atributo, y el cuerpo del
        default solo lo heredan las subclases explícitas."""

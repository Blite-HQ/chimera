...
- **Punto a ratificar por Sebas:** ~~la dirección del objetivo~~ (RESUELTA por el enunciado oficial 2026-07-18: el reto es Max-Cut — ver §1.8) y la adopción de "Ruta A+" (λ_C en el lazo) como extensión del recetario de la nota 02. **Ratificación de Sebas: PENDIENTE (solo Ruta A+).**

...
2. **Entregables del demo — CUBIERTOS como diseño en la nota 03** (Dockerfiles, compose, Fargate
   ...
   Fargate 29 jul). La implementación es de la fase de build, no de esta consolidación. **Geovanni

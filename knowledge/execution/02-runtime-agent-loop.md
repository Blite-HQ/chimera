...
- **El `kind` debe ser suficiente para saber, sin ejecutar nada, qué tipo de efecto tuvo el paso** —
  esto es lo que conecta con `side_effects` del `CapabilityManifest` v2 (trust/06, consumido en la nota
  03) para decidir si un replay puede simplemente "saltarse" un paso ya completado (`pure`,
